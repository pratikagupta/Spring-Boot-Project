...
//        return employeeEntity.map(employeeEntity1 -> modelMapper.map(employeeEntity1, EmployeeDTO.class));
    ...
    //log something
        // Prevent accidental update if client sends an id
        //inputEmployee.setId(null); // Ensure Hibernate treats it as new
    ...
    public EmployeeDTO updatePartialEmployeeById(Long employeeId, Map<String, Object> updates) {
        ...
        return modelMapper.map((Object) employeeRepository.save(employeeEntity), EmployeeDTO.class);
    }
}
