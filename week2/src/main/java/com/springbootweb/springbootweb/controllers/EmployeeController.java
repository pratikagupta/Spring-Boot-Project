...
import com.springbootweb.springbootweb.services.EmployeeServices;
...
//   }
    ...
    public ResponseEntity<EmployeeDTO> createNewEmployee(@RequestBody @Valid EmployeeDTO inputEmployee) {
        EmployeeDTO savedEmployee = employeeServices.createNewEmployee(inputEmployee);
    ...
    public ResponseEntity<EmployeeDTO> updatePartialEmployeeById(@RequestBody Map<String, Object> updates,
        ...
        EmployeeDTO employeeDTO = employeeServices.updatePartialEmployeeById(employeeId, updates);
